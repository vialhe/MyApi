...
BEGIN
    RAISERROR('Faltan catálogos base para ejecutar la prueba de cancelación de agenda.',16,1);
    RETURN;
END
...
BEGIN TRY
    ...
    EXEC dbo.sp_ui_agenda
        ...
        @fechaCita = '2026-04-15 09:00:00',
        @horaInicioProgramada = '2026-04-15 09:00:00',
        @horaFinProgramada = '2026-04-15 10:00:00',
        @idOrigenAgenda = @idOrigenAgenda,
        @requiereConfirmacion = 1,
        @observacionesInternas = 'Prueba cancelación agenda',
        @comentarios = 'Alta agenda para cancelar completa',
        @activo = 1,
        @idEntidad = @idEntidad,
    ...
    EXEC dbo.sp_ui_confirmarAgenda
        @folioAgenda = @folioAgendaGenerado,
        @comentarios = 'Confirmada para cancelación completa',
        @idEntidad = @idEntidad,
        @idUsuarioAlta = @idUsuario;

    /* 5) Cancelar agenda completa */
...
BEGIN CATCH
    ...
    RAISERROR('Error en script maestro de cancelación de agenda. Línea: %d. Mensaje: %s',16,1,@ErrorLine,@ErrorMessage);
END CATCH;